...
interface LendingSectionLegacyProps {
  onNavigateToTerminal?: () => void;
  preflightOk?: boolean;
}

const LendingSectionLegacy: React.FC<LendingSectionLegacyProps> = ({ onNavigateToTerminal, preflightOk = true }) => {
...
export default LendingSectionLegacy;
